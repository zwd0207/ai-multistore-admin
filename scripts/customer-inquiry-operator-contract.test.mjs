...
const withoutContext = adaptCustomerInquiry({ inquiry_id: 'generic-1', source: 'generic', store_id: 7, platform: 'naver', summary: '需要帮助', classification: 'answered', status: 'open' });
