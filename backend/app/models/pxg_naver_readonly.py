...
class PxgNaverReadonlyCustomerInquiry(Base):
    ...
    encrypted_customer_name: Mapped[str | None] = mapped_column(Text, nullable=True)
    customer_name_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    customer_name_length: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
    ...
    encrypted_answer_content: Mapped[str | None] = mapped_column(Text, nullable=True)
    answer_content_hash: Mapped[str | None] = mapped_column(String(64), nullable=True)
    answer_content_length: Mapped[int] = mapped_column(Integer, nullable=False, default=0, server_default="0")
