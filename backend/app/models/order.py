...
class Order(Base):
    ...
    external_product_order_id: Mapped[str | None] = mapped_column(String(120), nullable=True, index=True)
    ...
    receiver_phone: Mapped[str | None] = mapped_column(String(40), nullable=True)
    receiver_address: Mapped[str | None] = mapped_column(String(300), nullable=True)
