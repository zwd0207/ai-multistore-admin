...
const api = { list: dataProvider.getProducts, create: mockApi.createProduct, update: mockApi.updateProduct, remove: mockApi.deleteProduct };
...
export default function Products() { return <ResourcePage title="商品管理" description="查看并维护跨平台商品、价格及库存信息" resourceName="商品" api={api} columns={columns} fields={fields} statuses={statusOptions} platforms={platformOptions} initialForm={{ name: '', sku: '', store: '', platform: '', price: 0, stock: 0, status: '' }} readOnly={isBackendSource} />; }
