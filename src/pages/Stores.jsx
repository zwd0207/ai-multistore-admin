...
const api = { list: dataProvider.getStores, create: mockApi.createStore, update: mockApi.updateStore, remove: mockApi.deleteStore };
...
export default function Stores() { return <ResourcePage title="店铺管理" description="统一管理多平台店铺及其运营状态" resourceName="店铺" api={api} columns={columns} fields={fields} statuses={statusOptions} platforms={platformOptions} initialForm={{ name: '', platform: '', manager: '', region: '', products: 0, status: '' }} readOnly={isBackendSource} />; }
