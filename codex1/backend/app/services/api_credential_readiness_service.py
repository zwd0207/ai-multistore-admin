...
NAVER_CAPABILITY_MAP = {
    ...
    "naver.customer_inquiry_read": {
        ...
        "method": "GET",
        "docs_confirmed": True,
        "docs_reference_version": "current/2.82.0",
        "request_params_confirmed": True,
        "pagination_confirmed": True,
        "required_permission": "order_seller",
        "implemented_now": True,
        "safe_to_real_test": False,
        "token_type_required": "SELF_validation_pending",
        "account_id_required": False,
        "channel_no_required": False,
        "blocked_reason": "The official request and pagination contract is implemented, but one approved store must still confirm the order-seller grant and SELF token after rate-limit cooldown.",
    },
